export default {
  ...
  visualization: {
    ...
    market_network_tips:
      'To view templates from the template market, your server must be connected to the template market (https://cdn0-templates-dataease-cn.fit2cloud.com). Please check your network connection...',
